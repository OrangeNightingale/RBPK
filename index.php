...
$client_id = '381455114633-pboats9spphbmfkqomp7psnrc0e7bvt2.apps.googleusercontent.com'; // Client ID
$client_secret = 'mFeL2GglfhQfXVmqRN6e36iv'; // Client secret
$redirect_uri = 'http://localhost/MyPregnancy'; // Redirect URIs
